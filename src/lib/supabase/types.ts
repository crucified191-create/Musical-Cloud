...
export type Database = {
  public: {
    Tables: {
      ...
      video_playlists: TableConfig<VideoPlaylistRow, Omit<VideoPlaylistRow, "id" | "created_at" | "is_public"> & { id?: string; is_public?: boolean }, Partial<Pick<VideoPlaylistRow, "name" | "is_public">>>;
